...
namespace Framework.Orm.Dapper.SqlBuilder.DataAdapter
{
    ...
    /// SQLSERVER sql语句适配器
    /// </summary>
    internal class SqlServerAdapter : BaseSqlAdapter
    {
        internal override string ParamPrefix { get { return "@"; } }
        ...
        protected override string GetSelectSql()
        {
            ...
            if (ParamValues.Any())
            {
                if (base.SqlType == SqlTypeEnum.Select && base.OrderByColums.Any())
                {
